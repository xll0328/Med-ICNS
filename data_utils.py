...
from dataset_medical import CovidCTDataset
...
LABEL_FILES = {"places365":"data/categories_places365_clean.txt",
               ...
               "covid19-ct_train":'D:\\project\\XAI4Medical\\COVID-CT-master\\COVID-CT-master\\Data-split\\COVID\\trainCT_COVID.txt',
               "covid19-ct_val":'D:\\project\\XAI4Medical\\COVID-CT-master\\COVID-CT-master\\Data-split\\COVID\\valCT_COVID.txt',
               "covid19-ct_test":'D:\\project\\XAI4Medical\\COVID-CT-master\\COVID-CT-master\\Data-split\\COVID\\testCT_COVID.txt',
               "non_covid19-ct_train":'D:\\project\\XAI4Medical\\COVID-CT-master\\COVID-CT-master\\Data-split\\NonCOVID\\trainCT_NonCOVID.txt',
               "non_covid19-ct_val":'D:\\project\\XAI4Medical\\COVID-CT-master\\COVID-CT-master\\Data-split\\NonCOVID\\valCT_NonCOVID.txt',
               "non_covid19-ct_test":'D:\\project\\XAI4Medical\\COVID-CT-master\\COVID-CT-master\\Data-split\\NonCOVID\\testCT_NonCOVID.txt'}
...
def get_data(dataset_name, preprocess=None):
    if dataset_name =='covid19-ct_train':
        data = CovidCTDataset(root_dir='D:\\project\\XAI4Medical\\Label-free-CBM-main\\data\\covid19-ct',
                              txt_COVID=LABEL_FILES['covid19-ct_train'],
                              txt_NonCOVID=LABEL_FILES['non_covid19-ct_train'],
                              transform= train_transformer)
    if dataset_name =='covid19-ct_val':
        data = CovidCTDataset(root_dir='D:\\project\\XAI4Medical\\Label-free-CBM-main\\data\\covid19-ct',
                              txt_COVID=LABEL_FILES['covid19-ct_val'],
                              txt_NonCOVID=LABEL_FILES['non_covid19-ct_val'],
                              transform= train_transformer)
    if dataset_name =='covid19-ct_test':
        data = CovidCTDataset(root_dir='D:\\project\\XAI4Medical\\Label-free-CBM-main\\data\\covid19-ct',
                              txt_COVID=LABEL_FILES['covid19-ct_test'],
                              txt_NonCOVID=LABEL_FILES['non_covid19-ct_test'],
                              transform= train_transformer)
    # if dataset_name =='covid19-ct_train':
    #     data = dataset_medical.Covid19Dataset(root=os.path.join(os.path.dirname(os.path.abspath(__file__)),'data'),train =True,transform=preprocess)#!TODO 改成标签正确的数据集格式
    # if dataset_name =='covid19-ct_val':
    #     data = dataset_medical.Covid19Dataset(root=os.path.join(os.path.dirname(os.path.abspath(__file__)),'data'),train =False,transform=preprocess)
